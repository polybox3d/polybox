...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_PrinterPage_t, stringdata) + ofs \
...
QT_MOC_LITERAL(2, 34, 0)
    ...
    "PrinterPage\0on_pushButton_clicked\0\0"
};
...
const QMetaObject PrinterPage::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_PrinterPage.data,
      qt_meta_data_PrinterPage,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_PrinterPage.stringdata))
