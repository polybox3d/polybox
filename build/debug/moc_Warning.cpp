...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_Warning_t, stringdata) + ofs \
...
const QMetaObject Warning::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_Warning.data,
      qt_meta_data_Warning,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Warning.stringdata))
